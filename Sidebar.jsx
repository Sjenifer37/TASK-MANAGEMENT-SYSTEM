...
function Sidebar({ isSideBarOpen, setIsSideBarOpen, isEmployee = false }) {
          ...
          <div className="bg-white dark:bg-[#2b2c37] w-full py-4 rounded-xl">
            ...
            <div className="dropdown-borad flex flex-col h-[70vh] justify-between">
              <div>
                ...
                {/* ✅ Only show Create New Board for admin */}
                {!isEmployee && (
                  <div
              ...
              {/* Logout */}
              <div className="mx-2 p-4 flex justify-center items-center">
                <button
                  onClick={() => {
